...
* Remove pull step
* Config pull rebase
* Pull changes to the release branch before commiting
* Add base branch to pr creation
* Set output
* Add commit author
* Add --no-verify to workflow
* Wip
* Remove google fonts-related files
* Remove google fonts update workflow
